...
/**
 * Test case for class Tx_Dl_accounting_Controller_BillPositionController.
 *
 * @version $Id$
 ...
 */
class Tx_Dl_accounting_Controller_BillPositionControllerTest extends Tx_Extbase_Tests_Unit_BaseTestCase {
	/**
