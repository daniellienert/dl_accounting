...
/**
 * Test case for class Tx_Dl_accounting_Controller_CostTypeController.
 *
 * @version $Id$
 ...
 */
class Tx_Dl_accounting_Controller_CostTypeControllerTest extends Tx_Extbase_Tests_Unit_BaseTestCase {
	/**
