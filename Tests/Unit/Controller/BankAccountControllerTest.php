...
/**
 * Test case for class Tx_Dl_accounting_Controller_BankAccountController.
 *
 * @version $Id$
 ...
 */
class Tx_Dl_accounting_Controller_BankAccountControllerTest extends Tx_Extbase_Tests_Unit_BaseTestCase {
	/**
