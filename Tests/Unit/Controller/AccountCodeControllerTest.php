...
/**
 * Test case for class Tx_Dl_accounting_Controller_AccountCodeController.
 *
 * @version $Id$
 ...
 */
class Tx_Dl_accounting_Controller_AccountCodeControllerTest extends Tx_Extbase_Tests_Unit_BaseTestCase {
	/**
