 ...
 *
 */
class Tx_DlAccounting_Controller_AccountCodeController extends Tx_Extbase_MVC_Controller_ActionController {
	...
	public function createAction(Tx_DlAccounting_Domain_Model_AccountCode $newAccountCode) {
		...
		$this->flashMessageContainer->add('Your new AccountCode was created.');
		$this->redirect('list');
	}
	...
	public function updateAction(Tx_DlAccounting_Domain_Model_AccountCode $accountCode) {
		...
		$this->flashMessageContainer->add('Your AccountCode was updated.');
		$this->redirect('list');
	}
	...
	public function deleteAction(Tx_DlAccounting_Domain_Model_AccountCode $accountCode) {
		...
		$this->flashMessageContainer->add('Your AccountCode was removed.');
		$this->redirect('list');
	}
