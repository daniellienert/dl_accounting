	...
	'columns' => array(
		...
		'l10n_parent' => array(
			...
			'config' => array(
				...
				'foreign_table_where' => 'AND tx_dlaccounting_domain_model_bill.pid=###CURRENT_PID### AND tx_dlaccounting_domain_model_bill.sys_language_uid IN (-1,0)',
			),
		),
		...
		'user' => array(
			'exclude' => 0,
			'label' => 'LLL:EXT:dl_accounting/Resources/Private/Language/locallang_db.xml:tx_dlaccounting_domain_model_bill.user',
			'config' => array(
				'type' => 'inline',
